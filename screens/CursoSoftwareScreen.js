  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.courseDescription}>
        Desbloqueio de potencialidades avançadas: O curso sobre software de smartphones oferece conhecimento especializado em desbloqueios. 
        ...
        <Text style={styles.courseDescription}>
        Resolução de problemas brickados: Smartphones "brickados" (tornados inutilizáveis) devido a atualizações malsucedidas ou problemas de software
        ...
        <Text style={styles.courseDescription}>
        Acesso a um mercado específico: Há uma demanda crescente por profissionais capazes de resolver problemas de software em smartphones. Este curso abre portas
        ...
        <Text style={styles.courseDescription}>
        Economia de custos para os usuários finais: Com a capacidade de resolver problemas de software, desbloquear e restaurar dispositivos brickados, os usuários finais 
        ...
        <Text style={styles.courseDescription}>
        Exploração de possibilidades de personalização: Além de resolver problemas, o conhecimento em software de smartphones oferece a chance de personalizar e otimizar a
